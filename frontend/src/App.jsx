...
const API_URL =
  "https://document-summary-assistant-66if.onrender.com/api/summarize/";
  ...
  const handleSummarize = async () => {
    ...
    try {
      ...
      if (
        ...
        setError(
          "Unable to connect to the backend. Please check the backend service and try again."
        );
      } else {
        setError(
          err.message ||
        ...
        {hasResults && (
          <section className="results">
            ...
            <KeyPoints
              keyPoints={keyPoints}
              copiedSection={copiedSection}
              onCopy={handleCopyKeyPoints}
              cleanKeyPoint={cleanKeyPoint}
            />

            <ExtractedText
              extractedText={extractedText}
              copiedSection={copiedSection}
              onCopy={handleCopyExtractedText}
            />

            <Suggestions
              suggestions={suggestions}
              copiedSection={copiedSection}
              onCopy={handleCopySuggestions}
